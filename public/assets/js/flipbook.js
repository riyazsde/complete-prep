  ...
  (i.amdO = {}),
    (function () {
      ...
      var n,
        ...
        u = (a.utils = {
          ...
          getSharePrefixes: function () {
            return (
              a.defaults.sharePrefix + ",pdfflip-,flipbook-,pfflip-,pTPDFFLIP-"
            )
              .split(",")
              .map(function (e) {
                return e.trim();
            ...
            Array.prototype.forEach.call(t, function (t) {
              ...
              if (i && i.indexOf(t) >= 0 && !1 === e.hashFocusBookFound) {
                ...
                if (n.length > 0) {
                  ...
                  if (
                    (null != a && (a = a.split("/")[0]),
                    0 === (o = r("[data-pf-slug=" + n + "]")).length &&
                      (o = r("[data-slug=" + n + "]")),
                    0 === o.length && (o = r("#pf-" + n + ",#" + n)),
                    0 === o.length && (o = r("[data-_slug=" + n + "]")),
                    o.length > 0 &&
                      o.is(
                        "._pdfflip_thumb,._pdfflip_button,._df_custom,._df_link,._df_book,.pf-element,.dp-element"
                      ))
                  ) {
                    (o = r(o[0])),
                    ...
                    null != a && o.attr("data-hash-page", a),
                      o.addClass("pf-hash-focused", !0),
                      (null != o.data("lightbox") ||
                        null != o.data("pf-lightbox") ||
                        (null != o.attr("href") &&
      ...
      (u.getOptions = function (e) {
        (null == (e = r(e)).data("pf-option")) & (null == e.data("option")) &&
          e.data("pf-option", "option_" + e.attr("id")),
          void 0 !== e.attr("source") && e.data("pf-source", e.attr("source"));
          ...
          return e.replace(
            ...
            function (e, t, i, n, o) {
              ...
              return (
                ...
                '<a href="' +
                  a +
                  '" class="pf-autolink" target="_blank">' +
                  e +
                  "</a>"
              );
            }
        ...
        r(".dvcss").each(function () {
          ...
          if (e) {
            ...
            (window[n] = r.extend(!0, {}, window[n], e)),
              t.addClass("pf-element"),
              "none" !== e.lightbox &&
                (t.attr(
                  "data-pf-lightbox",
                  void 0 === e.lightbox ? "custom" : e.lightbox
                ),
                "thumb" == e.lightbox && t.attr("data-pf-thumb", e.pdfThumb),
                e.thumbLayout && t.attr("data-pf-thumb-layout", e.thumbLayout),
                e.apl && t.attr("apl", e.apl)),
              t.data("pf-option", n),
              t.attr("data-pf-slug", e.slug),
              t.attr("id", "df_" + e.id);
          }
        });
      }),
        (e.parseThumbs = function (t) {
          t.element.html(""),
            (null != t.thumbURL && "" != t.thumbURL.toString().trim()) ||
              (t.element.addClass("pf-thumb-not-found"),
          ...
          n.append(r("<div class='pf-book-page1'>")),
            n.append(r("<div class='pf-book-page2'>"));

          var o = r("<div class='pf-book-cover'>").append(i).appendTo(n),
            a = r(
              '<img width="210px" height="297px" class="pf-lazy" alt="' +
                t.title +
                '"/>'
            );
          ...
          a.attr("data-src", t.thumbURL),
            ...
            ("book-title-bottom" !== t.thumbLayout &&
              ...
              !0 === e.defaults.displayLightboxPlayIcon &&
                (t.element.removeClass("pf-icon-play-popup"),
                n.addClass("pf-icon-play-popup"))),
            t.element.addClass("pf-tl-" + t.thumbLayout),
              ...
              if ("true" !== t.data("pf-parsed")) {
                ...
                n.each(function () {
                  ...
                  o > e.defaults.loadMoreCount &&
                    t.append(
                      "<div class='pf-load-more-button-wrapper'><div class='pf-load-more-button'>Load More..</div></div>"
                    );
              }
            }
          }),
            (e.triggerId = 10),
            r(".pf-element").each(function () {
              var t = r(this);

              if (
                "true" !== t.attr("skip-parse") &&
                "true" !== t.data("pf-parsed")
              ) {
                t.data("pf-parsed", "true"), t.attr("pf-parsed", "true");
                ...
                if (void 0 === i)
                  t.addClass("pf-lazy-embed"), e.addLazyElement(t[0]);
                ...
                null != l &&
                  ...
                  l.forEach(function (i) {
                    t.attr("pf-trigger-id", e.triggerId),
                      r("#" + i)
                        .addClass("pf-trigger")
                        .attr("pf-trigger", e.triggerId);
                  })),
                  t.data("pf-editlink") &&
                    t.append(
                      '<a class="pf-edit-link" href="' +
                        t.data("pf-editlink") +
                        '" >Edit Book</a>'
                    );
              }
            ...
            (e.handleLazy = function () {
              ...
              if (
                ...
                if (i.length > 0) {
                  ...
                  n &&
                    (i.attr("data-pf-page", n.currentPageNumber),
              ...
              if ((t = e.embeds.shift())) {
                ...
                if (o.length > 0)
                  if (o.is("img"))
                    ...
                    null == a ? o.pdfflipinterface() : a.softInit(),
      ...
      (e.addLazyElement = function (t) {
        ...
        (e.initUtils = function () {
          ...
          (u.isSafari || u.isIOS) && t.addClass("pf-ios"),
            t.on("click", function () {}),
            t.on("click", ".pf-posts .pf-load-more-button", function () {
            ...
            e.defaults.shelfImage &&
              "" != e.defaults.shelfImage &&
              t.append(
                "<style>.pdfflip-onshelf ppf-flip-shelf:before, .pdfflip-onshelf ppf-flip-shelf:after{background-image: url('" +
                  e.defaults.shelfImage +
                  "');}</style>"
              );
        });
              ...
              },
              {
                ...
                value: function (e) {
                  void 0 === e && (e = this.isAnimating()),
                    this.app.container.toggleClass("pf-pending", e);
                },
              },
              {
                key: "initPages",
                    ...
                    return (
                      void 0 === i.textElement &&
                        ((i.textElement = jQuery(
                          "<div class='pf-text-content'>"
                        )),
                        i.contentLayer.append(i.textElement)),
                      !0 === t &&
                        (i.textElement.html(""),
                        i.textElement
                          .siblings(".pf-auto-link-content")
                          .html("")),
                      i.textElement[0]
                    );
                },
                ...
                value: function (e) {
                  N(M(r.prototype), "mouseDown", this).call(this, e),
                    e.srcElement === this.scrollBar[0] &&
                      ...
                      this.scrollBar.addClass("pf-active"),
                      this.scrollPageNumber.addClass("pf-active"));
                },
              },
              {
                key: "mouseUp",
                ...
                value: function (e) {
                  N(M(r.prototype), "mouseUp", this).call(this, e),
                    (this.isScrollBarPressed = this.scrollBar) &&
                      ...
                      this.scrollBar.removeClass("pf-active"),
                      this.scrollPageNumber.removeClass("pf-active"));
                },
              },
            ]),
            n && L(i.prototype, n),
      ...
      var Z = e.utils,
        K = (function (t) {
          ...
          function n(t, o) {
            ...
            return (
              B(this, n),
              (t.viewerClass = "pf-flipbook " + (t.viewerClass || "")),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (o = Z.limitAt(o, this.minZoom, n)),
                    ...
                    (e.zoomValue = o),
                    (r || a) &&
                      (e.container.toggleClass("pf-zoom-active", 1 !== o),
                      r && this.enterZoom(),
                      a && this.exitZoom());
                },
              },
        ...
        Q = (function (t) {
          ...
          function n(e, t) {
            ...
            return (
              B(this, n),
              (e.viewerClass = "pf-zoomview " + (e.viewerClass || "")),
            ...
            U(n, [
              {
                ...
                value: function () {
                  (this.leftPage = new O()),
                    ...
                    this.leftPage.element.addClass("pf-page-back"),
                    this.rightPage.element.addClass("pf-page-front"),
                    ...
                    this.wrapper.addClass("pf-sheet");
                },
              },
              {
                key: "initEvents",
            ...
            te(n, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  !1 === t.isFlipping &&
                    (e.needsFlip
                      ? (t.element.addClass("pf-flipping"), t.flip())
                      : ((t.skipFlip = !1),
                        t.element.removeClass(
                          "pf-flipping pf-quick-turn pf-folding pf-left-side pf-right-side"
                        ),
                        t.element.addClass(
                    ...
                    (t.visible = e.visible),
                    t.isHard
                      ? t.element.addClass("pf-hard-sheet")
                      : (t.element.removeClass("pf-hard-sheet"),
            ...
            fe(i, [
              {
                ...
                value: function () {
                  ...
                  (e.frontPage = new O()).element
                    .addClass("pf-page-front")
                    .appendTo(e.element),
                    (e.backPage = new O()).element
                      .addClass("pf-page-back")
                      .appendTo(e.element),
            ...
            fe(n, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (t.isInsideSheet =
                      jQuery(e.srcElement).closest(".pf-page").length > 0),
                    (t.isInsideCorner = !1),
                    t
                  );
                },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  jQuery(n.domElement)
                    ...
                    .addClass("pf-3dcanvas pf-csscanvas"),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    r.stroke(),
                    r.beginPath(),
                    (r.strokeStyle = "rgba(255,255,255,0.5)"),
                    (r.lineWidth = 4),
                    r.moveTo(0, 0),
                    r.lineTo(0, o),
                    r.moveTo(0, 0),
      ...
      (y.prototype.pinchDown = function (e) {
        ...
        (y.prototype.pinchUp = function (e) {
          null != e.touches &&
            ...
            this.app.container.removeClass("pf-pinch-zoom"),
        ...
        (y.prototype.pinchMove = function (t) {
          if (
            ...
            (this.pinchZoomDirty = !0),
              this.app.container.addClass("pf-pinch-zoom");
            ...
            Ue(n, [
              {
                ...
                value: function () {
                  je(qe(n.prototype), "init", this).call(this),
                    ...
                    this.app.container.addClass("pf-hybrid-viewer pf-pending");
                },
              },
              {
                key: "getAnnotationElement",
                  ...
                  var t,
                    ...
                    o = function t(o) {
                      ...
                      a
                        ...
                        : (n.pdfApp.container.addClass("pf-fetch-pdf"),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    e.updateInfo("ERROR : No PDF File provided! ", "pf-error");
                },
              },
              {
                key: "pdfFetchStarted",
                ...
                value: function () {
                  (this.pdfFetchStatusCount = 0),
                    this.app.container.addClass("pf-fetch-pdf"),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (e.searchHits = []),
                    ...
                    e.app.container.removeClass("pf-search-open"),
                    (e.textSearch = ""),
                    e.app.container.find(".pf-search-hits").remove();
                },
              },
              {
                key: "search",
                  ...
                  t.textSearch !== e &&
                    ...
                    e.length < 3 && "" != e
                      ...
                      : ((t.textSearch = e),
                        ...
                        t.app.searchContainer.addClass("pf-searching"),
                        t.app.container.addClass("pf-fetch-pdf"),
                        t._search(e, 1)));
                },
              },
              {
                    ...
                    i
                      ...
                      .finally(function () {
                        0 == i.totalHits
                          ...
                          i.app.searchContainer.removeClass("pf-searching"),
                          i.app.container.removeClass("pf-fetch-pdf");
                      });
                },
              },
              {
      ...
      var kt = e.jQuery,
                    ...
                    o.thumbnail
                      .on("click", function () {
                        ...
                        null == n.thumblist && n.initThumbs(),
                          n.thumbContainer.toggleClass("pf-sidemenu-visible"),
                          e.toggleClass("pf-active"),
                          e.hasClass("pf-active") &&
                            (e.siblings(".pf-active").trigger("click"),
                      ...
                      o.outline
                        .on("click", function () {
                          ...
                          if (
                            ...
                            e.toggleClass("pf-active"),
                              i.toggleClass("pf-sidemenu-visible"),
                              e.hasClass("pf-active") &&
                                e.siblings(".pf-active").trigger("click"),
                              t.update(),
                              !1 === n.options.sideMenuOverlay &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.options.logo.indexOf("<") > -1
                    ? (t = kt(e.options.logo).addClass("pf-logo pf-logo-html"))
                    : e.options.logo.trim().length > 2 &&
                      (t = kt(
                        '<a class="pf-logo pf-logo-img" target="_blank" href="' +
                          e.options.logoUrl +
                          '"><img alt="" src="' +
                          e.options.logo +
                          '"/>'
                ...
                value: function () {
                  ...
                  i.toString() !== e.currentPageNumber.toString()
                    ...
                    e.container.toggleClass(
                      "pf-sidemenu-open",
                      e.container.find(".pf-sidemenu-visible").length > 0
                    );

                  var n =
                    e.provider.totalHits > 0 &&
                    e.container.find(".pf-sidemenu-visible.pf-search-container")
                      .length > 0;

                  if ((e.container.toggleClass("pf-search-open", n), n)) {
                    var o = e.searchContainer.find(
                      ".pf-search-result[data-pf-page=" +
                        e.currentPageNumber +
                        "]"
                    );
                    ...
                    if (
                      (e.searchContainer
                        .find(".pf-search-result.pf-active")
                        .removeClass("pf-active"),
                      o.length > 0 && !o.hasClass(".pf-active"))
                    ) {
                  ...
                  t.openRight.toggleClass("pf-hidden", p),
                    t.openLeft.toggleClass("pf-hidden", h),
            ...
            xt(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  (i.wrapper = kt(
                    '<div class="pf-share-wrapper" style="display: none;">'
                  ).on("click", function () {
                    i.close();
                  })),
                    (i.box = kt('<div class="pf-share-box">')),
                    ...
                    i.box
                      .appendTo(i.wrapper)
                      .html(
                        '<span class="pf-share-title">' +
                          t.text.share +
                          "</span>"
                      ),
                    (i.urlInput = kt(
                      '<textarea name="pf-share-url" class="pf-share-url">'
                    ).on("click", function () {
                      kt(this).select();
                    })),
                  ...
                  var n = function () {
                    if (
                      ...
                      null !== e &&
                        ((i[o] = kt("<div>", {
                          class:
                            "pf-share-button pf-share-" + o + " " + t.icons[o],
                        }).on("click", function (n) {
                          n.preventDefault(),
                            window.open(
                              e
        ...
        Nt = (function () {
          function t(i) {
            ...
            return (
              (n.lightboxWrapper = kt("<div>").addClass("pf-lightbox-wrapper")),
              (n.backGround = kt("<div>")
                .addClass("pf-lightbox-bg")
                .appendTo(n.lightboxWrapper)),
              (n.element = kt("<div>")
                .addClass("pf-app")
                .appendTo(n.lightboxWrapper)),
              (n.controls = kt("<div>")
                .addClass("pf-lightbox-controls")
                .appendTo(n.lightboxWrapper)),
              (n.closeButton = kt("<div>")
                .addClass(
                  "pf-lightbox-close pf-ui-btn " + e.defaults.icons.close
                )
                .on("click", function () {
                  n.close(i);
                })
            ...
            xt(t, [
              {
                ...
                value: function (e) {
                  return (
                    ...
                    kt("html,body").addClass("pf-lightbox-open"),
              ...
              },
              {
                ...
                value: function (t) {
                  return (
                    ...
                    kt("html,body").removeClass("pf-lightbox-open"),
                    this.element.attr("class", "pf-app").attr("style", ""),
                    this.lightboxWrapper
                      .attr("class", "pf-lightbox-wrapper")
                      .attr("style", ""),
        ...
        It = (function () {
          function e() {
            ...
            return (
              (t.frame = kt(
                '<iframe id="pf-print-frame" style="display:none">'
              ).appendTo(kt("body"))),
        ...
        Mt = (function () {
          function t(e) {
            ...
            for (var a = this, r = 0; r < this.totalRows; r++) {
              ...
              (p.className = "pf-wrapper"),
                (h.className = "pf-thumb-number"),
                (s.className = "pf-thumb"),
                (u.className = "pf-bg-image"),
                (p.style.height = i + "px"),
                (p.style.width = n + "px"),
            ...
            xt(t, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    t.thumbContainer.hasClass("pf-sidemenu-visible")
                  ) {
                    var i = t.thumblist.container,
                      n = i.scrollTop,
                      o = i.getBoundingClientRect().height,
                      a = t.thumbContainer.find(
                        "#pf-thumb" + t.currentPageNumber
                      );
                  ...
                  if (
                    ...
                    for (var s = 0; s < r.length; s++) {
                      ...
                      if (
                        void 0 !== l &&
                        !1 === l.classList.contains("pf-thumb-loaded") &&
                        !1 === l.classList.contains("pf-thumb-requested")
                      )
                        return (
                          l.classList.add("pf-thumb-requested"),
                ...
                value: function (t) {
                  ...
                  if (t.textureTarget === e.TEXTURE_TARGET.THUMB) {
                    ...
                    a.find(".pf-wrapper").css({
                      ...
                      a
                        .addClass("pf-thumb-loaded")
                        .removeClass("pf-thumb-requested");
                  }
      ...
      function Dt() {
        if (void 0 === e.openLocalFileInput) {
          var t = (e.openLocalFileInput = kt(
            ...
            .appendTo(kt("body"))
            .data("pf-option", e.openFileOptions));
          ...
          (void 0 !== e.activeLightBox.app &&
            ...
            null === e.activeLightBox.app &&
              e.activeLightBox.show(function () {
                (e.activeLightBox.app = kt(
                  e.activeLightBox.element
                ).pdfflipinterface({
                  transparent: !1,
        ...
        (e.initControls = function () {
          ...
          if (
            (!1 !== e.defaults.autoPDFLinktoViewer &&
              t.on("click", 'a[href$=".pdf"]', function (t) {
                ...
                void 0 !== i.attr("download") ||
                  ...
                  i.hasClass("pf-ui-btn") ||
                  i.parents(".pf-app").length > 0 ||
                  (t.preventDefault(),
                  i.data("pf-source", i.attr("href")),
                  e.openLightBox(i));
              }),
            ...
            t.on("click", ".pf-sidemenu-buttons .pf-ui-close", function () {
              kt(this)
                .closest(".pf-app")
                .find(".pf-ui-btn.pf-active")
                .trigger("click");
            }),
            t.on(
              "mouseout",
              ".pf-link-content section.squareAnnotation, .pf-link-content section.textAnnotation, .pf-link-content section.freeTextAnnotation",
              function () {
                var t = kt(this);
            ...
            i.length > 0 &&
              (i.on("dragover", function (e) {
                e.preventDefault(),
                  e.stopPropagation(),
                  kt(this).addClass("pf-dragging");
              }),
              i.on("dragleave", function (e) {
                e.preventDefault(),
                  e.stopPropagation(),
                  kt(this).removeClass("pf-dragging");
              }),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  this.element
                    .addClass("pf-app")
                    .removeClass("pf-container pf-loading"),
                    (this.container = Bt("<div>").appendTo(this.element)),
                    this.container.addClass(
                      "pf-container pf-loading pf-init pf-controls-" +
                        ...
                        ("transparent" === this.options.backgroundColor
                          ...
                          : "") +
                        (!0 === this.isRTL ? " pf-rtl" : "") +
                        (!0 === Ut.isIOS || !0 === Ut.isIPad ? " pf-ios" : "")
                    ),
                    (this._offsetParent = this.container[0].offsetParent),
                    (this.backGround = Bt("<div class='pf-bg'>")
                    ...
                    this.viewerContainer.addClass("pf-viewer-container");
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (void 0 !== window[e.locationVar]) {
                    ...
                    console.warn("pdfflipinterface locationVar not found!");
              ...
              },
              {
                ...
                value: function (e) {
                  (this.userHasInteracted = !0),
                    !0 === this.viewer.acceptAppMouseEvents &&
                      0 === Bt(e.srcElement).closest(".pf-sidemenu").length &&
              ...
              },
              {
                ...
                value: function () {
                  (this.resizeRequestStatus = Ht.COUNT),
                    (this.resizeRequestCount = 0),
                    this.container.addClass("pf-pendingresize"),
              ...
              },
              {
                ...
                value: function () {
                  this.resize(),
                    ...
                    this.container.removeClass("pf-loading pf-init"),
                    this.viewer.onReady(),
                    this.analytics({
                    ...
                    !0 ===
                      this.options.dataElement.hasClass("pf-hash-focused") &&
                      (Ut.focusHash(this.options.dataElement),
                      this.options.dataElement.removeClass("pf-hash-focused")),
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    t = Bt("<div>").addClass(
                      "pf-outline-container pf-sidemenu"
                    );

                  t.append(
                    '<div class="pf-sidemenu-title">Table of Contents</div>'
                  );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = Bt("<div>").addClass(
                    "pf-thumb-container pf-sidemenu"
                  );

                  t.append('<div class="pf-sidemenu-title">Thumbnails</div>'),
                    t.append(Bt(e.thumblist.container).addClass("pf-wrapper")),
                    (e.thumbContainer = t),
                    e.sideMenu.element.append(t),
                    e.container.on(
                      "click",
                      ".pf-thumb-container .pf-thumb",
                      function (t) {
                        t.stopPropagation();
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.append('<div class="pf-sidemenu-title">Search</div>'),
                    (e.searchForm = Bt('<div class="pf-search-form">').appendTo(
                      t
                    )),
                    (e.searchBox = Bt(
                      '<input type="text" class="pf-search-text" placeholder="Search">'
                    )
                      .on("keyup", function (t) {
                    ...
                    (e.searchButton = Bt(
                      '<div class="pf-ui-btn pf-search-btn pf-icon-search">'
                    )
                      .on("click", function (t) {
                        e.search();
                      })
                      .appendTo(e.searchForm)),
                    (e.clearButton = Bt('<a class="pf-search-clear">Clear</a>')
                      .on("click", function (t) {
                        e.clearSearch();
                      })
                      .appendTo(e.searchForm)),
                    (e.searchInfo = Bt('<div class="pf-search-info">').appendTo(
                      t
                    )),
                    (e.searchResults = Bt(
                      '<div class="pf-wrapper pf-search-results">'
                    ).appendTo(t)),
                    (e.searchContainer = t),
                    e.sideMenu.element.append(t),
                    e.container.on("click", ".pf-search-result", function (t) {
                      t.stopPropagation();
                      ...
                      (null !== e._offsetParent || e.isFullscreen) &&
                        ...
                        e.refreshRequestStatus === Ht.ON
                          ? ((e.refreshRequestStatus = Ht.OFF),
                            (e.pendingResize = !1),
                            e.viewer.refresh(),
                            this.container.removeClass("pf-pendingresize"))
              ...
              },
              {
                ...
                value: function () {
                  var t,
                    ...
                    n = this,
                    o = (n.isSideMenuOpen =
                      n.container.hasClass("pf-sidemenu-open")),
                    a = n.dimensions,
                  ...
                  if (
                    ...
                    (a.containerWidth = a.isFullSize
                      ...
                      : this.element.width()),
                    n.container
                      .toggleClass("pf-xs", a.containerWidth < 400)
                      .toggleClass("pf-xss", a.containerWidth < 320),
                    (a.maxHeight =
                      s -
                ...
                value: function (e) {
                  ...
                  (e = t.getValidPage(parseInt(e, 10))),
                    null !== t.viewer &&
                      ...
                      t.container.removeClass("pf-fetch-pdf"),
                      (t.oldPageNumber = t.currentPageNumber),
                      (t.currentPageNumber = e),
                  ...
                  (s = r.getViewport({
                    ...
                    r.getTextContent().then(function (r) {
                      ...
                      if (
                        ...
                        0 == v.length &&
                          ((v = jQuery('<div class="pf-auto-link-content">')),
                        ...
                        m._textDivs.forEach(function (e) {
                          ...
                          for (a = 0; a < t.searchHits.length; a++)
                            (i += t.str.substring(n, t.searchHits[a].start)),
                              ...
                              (o = t.searchHits[a].length),
                              (i +=
                                '<span class="pf-search-highlight">' +
      ...
      (Qt.defaults.viewerType = "flipbook"),
        ...
        (Qt.slug = "TPDFFLIP"),
        (Qt.locationVar = "TPDFFLIPLocation"),
        (Qt.locationFile = "flipbook"),
        (Qt.PAGE_MODE = {
          SINGLE: 1,
        ...
        (Qt.parseFallBack = function () {
          Kt(".pf-posts").addClass("pdfflip-books"),
            Kt(".pdfflip-books").addClass("pf-posts"),
            Kt(
              "._pdfflip_button, ._pdfflip_thumb, ._df_custom, ._pdfflip_book, ._df_hidden"
            ).each(function () {
              var e = Kt(this);

              "true" !== e.data("pf-parsed") &&
                (e.addClass("pf-element"),
                e.hasClass("_pdfflip_book") ||
                  (e.hasClass("_pdfflip_thumb")
                    ? (e.attr("data-pf-lightbox", "thumb"),
                      void 0 !== e.attr("thumb") &&
                        e.data("pf-thumb", e.attr("thumb")))
                    : e.hasClass("_pdfflip_button")
                    ? e.attr("data-pf-lightbox", "button")
                    : e.hasClass("_df_hidden")
                    ? e.attr("data-pf-lightbox", "hidden")
      ...
      var Xt = function (e) {
        if (
          ...
          "undefined" != typeof TPDFFLIPWPGlobal && "true" === e.wpOptions)
        ) {
          if (!0 !== e.linksparsed) {
            e.linksparsed = !0;
      ...
      Kt.fn.extend({
        ...
        Kt(document).ready(function () {
          ...
          Qt.executeCallback("beforeThePdfFlipInit"),
            void 0 !== window.TPDFFLIPWPGlobal &&
              Kt.extend(!0, Qt.defaults, Xt(window.TPDFFLIPWPGlobal)),
            Qt.initUtils(),
            Qt.initControls(),
            e.on(
              "click",
              ".pf-element[data-pf-lightbox],.pf-element[data-lightbox]",
              function (e) {
                ...
                if (!t || !t.hasClass("pf-edit-link")) {
                  ...
                  "#" === o || void 0 === o || i.hasClass("pf-hash-focused")
                    ? (a = !0)
                    : "_self" === n ||
                      "_blank" === n ||
            ...
            Qt.executeCallback("afterThePdfFlipInit");
        }),
        (u.finalizeOptions = function (e) {
          return Xt(e);
        }),
