...
const ChatBotAiCarrierGuidence = () => {
  ...
  const sendMessage = async () => {
    ...
    // placeholder assistant message (will be animated)
    ...
    try {
      const messagesForApi = [
        {
          role: "system",
          content: `You are "Career Mentor Pro" — a senior software engineering mentor and career strategist focused on frontend and React development.

Response rules:
1. Focus on career guidance, growth strategy, portfolio, interview prep, and long-term progression.
2. Structure replies:
   - Career Guidance
   - Skill Roadmap
...
3. Tailor advice to the user's background and intent (frontend React developer, transition, fresher, etc.).
4. Keep tone professional, precise, and mentorship-driven.`
        },
        ...
        <div className="bg-gradient-to-r from-emerald-700 to-emerald-500 text-white p-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
              <Icon icon="mdi:briefcase-account" width="20" height="20" />
            </div>
            <div className="text-lg font-semibold">Prepo Ai</div>
            <div className="text-xs text-white/80 ml-2">Career Mentor Pro</div>
          </div>
...
export default ChatBotAiCarrierGuidence;
