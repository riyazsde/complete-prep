...
const SkillsPage1 = () => {
  ...
  }, [isAuthenticated, goal,searchQuery]);
  ...
  return (
    <div className="user_container px-4 md:px-10 py-6 space-y-6">
      ...
      <div className="w-full">
        <h2 className="text-lg font-bold bg-yellow-300 text-green-900 px-4 py-2 rounded-3xl inline-flex items-center gap-2 shadow-sm">
          <Icon
            ...
            {courses?.map((course, idx) => (
              ...
              >
                <div className="relative">
                  ...
                  />
                  {course.name && (
                    <span className="absolute top-2 right-2 bg-white text-gray-800 text-xs px-2 py-0.5 rounded-md shadow-sm font-bold">
                      {course.name}
                    </span>
                  )}
                </div>
...
export default HOC(SkillsPage1);
